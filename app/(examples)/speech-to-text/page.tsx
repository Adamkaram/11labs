...
import { ChevronLeft, Mic, FileAudio } from 'lucide-react';
...
import { MicrophoneRecorder } from '@/app/(examples)/speech-to-text/components/microphone-recorder';
import {
      ...
      <div>
        <Tabs defaultValue="file" className="mb-6">
          ...
          <TabsContent value="microphone">
            <MicrophoneRecorder
              onRecordingComplete={handleFileChange}
              disabled={transcription.isProcessing}
            />
          </TabsContent>
        </Tabs>
